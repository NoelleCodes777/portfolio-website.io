  ...
  const my_education_data = [
    {
      ...
      college_name: "National Open University",
      college_degree_name: "B.Sc. in Computer Science",
      education_spam: "2021-Present",
      education_info: [
        {
          index: 1,
          educ_info:
            "⚡ I am currently studying Computer Science subjects like data structure and algorithm.",
        },
        {
          index: 2,
          educ_info:
            "⚡ Apart from this, I have done courses on Back-end Development(Django), and Front-end Development (ReactJS).",
        },
        {
          index: 3,
          educ_info:

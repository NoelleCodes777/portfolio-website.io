    ...
    <>
      <div className="proj_containar_section">
        <div className="proj_left">
          ...
          <p>
          Hello there! Welcome to my GitHub profile overview. I'm excited to share my
          experience
            You can find all of my projects on my profile on Github. You can
            view my activities and code on these projects. Some
          ...
          <Githubcomp
            ...
            href="https://github.com/NoelleCodes777"
          />
        </div>

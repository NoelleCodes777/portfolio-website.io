...
function Skills() {
  const my_skill_description = [
    {
      index: 1,
      info: '⚡ Building responsive website with front end using ReactJS and wordpress plugins',
    },
    {
      index: 2,
      info: '⚡Building robots using Lego mindstrom software to code',
    },
    {
      index: 3,
      info: '⚡ Creating application backend in Django',
    },
  ];
  return (
    <>
